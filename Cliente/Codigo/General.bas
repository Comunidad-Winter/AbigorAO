...
Recompensas(MAGO, 3, 1).Name = "Grito del mas allá"
Recompensas(MAGO, 3, 1).Descripcion = "Aumenta el daño base mínimo de Juicio Final en 10 puntos."

Recompensas(MAGO, 3, 2).Name = "Destrucción"
Recompensas(MAGO, 3, 2).Descripcion = "Aumenta el daño base máximo de Implosión en 10 puntos."
...
RG(3, 1) = 255      'Caos Rojo
RG(3, 2) = 0
RG(3, 3) = 0

RG(4, 1) = 0        'Newbies Verde
RG(4, 2) = 240
RG(4, 3) = 0

RG(5, 1) = 190      'Renegados Gris
RG(5, 2) = 190
RG(5, 3) = 190

RG(6, 1) = 128      'Funda clan Violeta
RG(6, 2) = 0
RG(6, 3) = 124

RG(7, 1) = 255      'Donadores Amarillo
RG(7, 2) = 255
RG(7, 3) = 0

RG(8, 1) = 200      'Semi-Dios violeta claro
RG(8, 2) = 88
RG(8, 3) = 209

RG(9, 1) = 0      'Soporte Celeste
RG(9, 2) = 255
RG(9, 3) = 255
...
Do While prgRun
    ...
    End If
        ...
        If DirectX.TickCount - lFrameTimer > 1000 Then
            ...
            If FPSFLAG Then frmMain.Caption = "Abigor AO" & " V " & App.Major & "." & App.Minor & "." & App.Revision
