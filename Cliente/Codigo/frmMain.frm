...
Begin VB.Form frmMain 
   ...
   Begin VB.Image ImgMen 
      ...
      Height          =   300
      Left            =   11280
      MouseIcon       =   "frmMain.frx":63799
      MousePointer    =   99  'Custom
      Picture         =   "frmMain.frx":64463
      Top             =   1080
      Visible         =   0   'False
      Width           =   300
   End
...
Sub Form_Load()
'BETA
IPdelServidor = "201.212.4.165"

PuertoDelServidor = 10200

FPSFLAG = True

Me.Picture = LoadPicture(DirGraficos & "Principal.jpg")
...
Private Sub TimerRevive_Timer()
Call SendData("REVIVIR")
Me.TimerRevive.Enabled = False
