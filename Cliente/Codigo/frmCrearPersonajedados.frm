    ...
    Case 0
        ...
        If CheckData() Then
            ...
            If Not CheckMailString(UserEmail) Then
                MsgBox "Direccion de mail inválida.", vbExclamation, "Abigor AO"
                txtCorreo.SetFocus
                Exit Sub
            End If
            ...
            If Len(Trim(txtPasswd)) = 0 Then
                MsgBox "Tenés que ingresar una contraseña.", vbExclamation, "Abigor AO"
                txtPasswd.SetFocus
                Exit Sub
            End If
            ...
            If Trim(txtPasswd) <> Trim(txtPasswdCheck) Then
                MsgBox "Las contraseñas no coinciden.", vbInformation, "Abigor AO"
                txtPasswd = ""
                txtPasswdCheck = ""
                txtPasswd.SetFocus
                Exit Sub
