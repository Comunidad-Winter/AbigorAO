...
Begin VB.Form frmOpciones 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Height          =   335
      Left            =   2350
      MouseIcon       =   "frmOpciones.frx":10CCA
   ...
   Begin VB.PictureBox PictureSanado 
      ...
      Height          =   335
      Left            =   2350
      MouseIcon       =   "frmOpciones.frx":10FD4
      MousePointer    =   99  'Custom
      ScaleHeight     =   300
      ScaleWidth      =   300
      TabIndex        =   7
   ...
   Begin VB.PictureBox PictureRecuMana 
      ...
      Height          =   335
      Left            =   840
      MouseIcon       =   "frmOpciones.frx":112DE
      MousePointer    =   99  'Custom
      ScaleHeight     =   300
      ScaleWidth      =   300
      TabIndex        =   6
   ...
   Begin VB.PictureBox PictureVestirse 
      ...
      Height          =   335
      Left            =   840
      MouseIcon       =   "frmOpciones.frx":115E8
      MousePointer    =   99  'Custom
      ScaleHeight     =   300
      ScaleWidth      =   300
      TabIndex        =   5
   ...
   Begin VB.PictureBox PictureMenosCansado 
      ...
      Height          =   335
      Left            =   2350
      MouseIcon       =   "frmOpciones.frx":118F2
      MousePointer    =   99  'Custom
      ScaleHeight     =   300
      ScaleWidth      =   300
      TabIndex        =   4
   ...
   Begin VB.PictureBox PictureNoHayNada 
      ...
      Height          =   335
      Left            =   2350
      MouseIcon       =   "frmOpciones.frx":11BFC
      MousePointer    =   99  'Custom
      ScaleHeight     =   300
      ScaleWidth      =   300
      TabIndex        =   3
   ...
   Begin VB.PictureBox PictureOcultarse 
      ...
      Height          =   335
      Left            =   840
      MouseIcon       =   "frmOpciones.frx":11F06
      MousePointer    =   99  'Custom
      ScaleHeight     =   300
      ScaleWidth      =   300
      TabIndex        =   2
   ...
   Begin VB.PictureBox PictureFxs 
      ...
      Height          =   335
      Left            =   2350
      MouseIcon       =   "frmOpciones.frx":12210
      MousePointer    =   99  'Custom
      ScaleHeight     =   300
      ScaleWidth      =   300
      TabIndex        =   1
   ...
   Begin VB.PictureBox PictureMusica 
      ...
      Height          =   335
      Left            =   840
      MouseIcon       =   "frmOpciones.frx":1251A
      MousePointer    =   99  'Custom
      ScaleHeight     =   300
      ScaleWidth      =   300
      TabIndex        =   0
   ...
   Begin VB.Label Label11 
      ...
      Height          =   255
      Left            =   720
      MouseIcon       =   "frmOpciones.frx":12824
      MousePointer    =   99  'Custom
      TabIndex        =   18
      Top             =   3360
      Width           =   1455
   ...
   Begin VB.Image Image1 
      Height          =   375
      Left            =   0
      MouseIcon       =   "frmOpciones.frx":12B2E
      MousePointer    =   99  'Custom
      Top             =   4800
      Width           =   735
   End
...
ShellExecute Me.Hwnd, "open", "http://www.abigoronline.com.ar/public_html/Html/manual/", "", "", 1
