...
Dim i As Integer, iX As Integer, tX As Integer, DifX As Integer, dNum As String
    ...
    iX = Inet1.OpenURL("abigor-ao.ucoz.es/VEREXE.txt")
    tX = LeerInt(App.Path & "\INIT\Update.ini")
    DifX = iX - tX
 
If Not (DifX = 0) Then MsgBox "Hay actualizaciones pendientes.Se ejecutará el autoupdate."
If Not (DifX = 0) Then Call ShellExecute(Me.Hwnd, "open", App.Path & "/AutoUpdate Abigor-AO.exe", "", "", 1): End
End Function
