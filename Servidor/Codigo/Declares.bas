...
Public Const Anillo As Integer = "841"
...
Public MinutosDiaNoche As Byte
...
Public Const AdicionalSTLeñador = 100
Public Const AdicionalSTPescador = 100
Public Const AdicionalSTMinero = 100
...
Public Const FONTTYPE_GLOBAL = "~163~44~163~0~1"
...
Public Const MapaRetoPJ = 60
Public Const MapaRetoX1 = 36
Public Const MapaRetoY1 = 73
Public Const MapaRetoX2 = 20
Public Const MapaRetoY2 = 52
...
Type UserFlags
    ...
    ElTexto As String
    ElDia As String
    RespuestaX As String
    AfectaNPC As Integer
...
Type UserCounters
    ...
    TiempoSilenc As Single
    PenaSilenc As Single
    Pena As Single
...
Public Const HOGAR_NIX = 3
Public Const HOGAR_ULLATHORPE = 4
