...
Select Case UCase$(Left$(rdata, 2))
    ...
    Case "UK"
        ...
        Select Case val(rdata)
            ...
            Case Magia
            If Hechizos(UserList(UserIndex).Stats.UserHechizos(UserList(UserIndex).flags.Hechizo)).RingNeeded = 1 Then
...
Select Case UCase$(rdata)
    ...
    Case "PARSAL"
       ...
       Case "REVIVIR"
        Call RevivirUsuario(UserIndex, Revividor, UserList(UserIndex).Clase = CLERIGO And UserList(UserIndex).Recompensas(3) = 2)
        Exit Sub
