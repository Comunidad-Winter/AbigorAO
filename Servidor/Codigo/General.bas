...
Public Sub LogPuntos(Texto As String)
On Error GoTo errhandler
...
nfile = FreeFile
    ...
    Open App.Path & "\logs\PuntosCanjes.log" For Append Shared As #nfile
...
End Sub
Public Sub LogCanjes(Texto As String)
On Error GoTo errhandler
...
nfile = FreeFile
    ...
    Open App.Path & "\logs\Canjes.log" For Append Shared As #nfile
    Print #nfile, Date & " " & Time & " " & Texto
    Close #nfile
