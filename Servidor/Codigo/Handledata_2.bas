...
Select Case Left$(UCase$(rdata), 2)
    ...
    Case "#Y"
       ...
       Case "#•"
        ...
        Else
                ...
                Call SendData(ToIndex, UserIndex, 0, "||" & UserList(UserIndex).Name & " Envió: " & rdata)
        ...
        GMTitulo = ReadField(1, rdata, 172)
        GMMensaje = ReadField(2, rdata, 172)
 
        UserList(UserIndex).flags.Consulta = 1
        UserList(UserIndex).flags.Asunto = "Asunto: " & GMTitulo
        UserList(UserIndex).flags.ElTexto = "Consulta: " & GMMensaje
        UserList(UserIndex).flags.ElDia = "Fecha de envio: " & GMDia
    ...
    Case "#0"
       ...
       If UCase$(rdata) = "TODO" Then
        UserList(UserIndex).Stats.GLD = UserList(UserIndex).Stats.GLD + UserList(UserIndex).Stats.Banco
