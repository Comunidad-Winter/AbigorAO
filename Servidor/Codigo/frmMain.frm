...
Begin VB.Form frmMain 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Timer Tlimpiar 
         ...
         Top             =   600
      End
      Begin VB.Timer BackupAU 
         Interval        =   60000
         Left            =   3720
         Top             =   600
      End
      Begin VB.Timer DiaNoche 
         Interval        =   60000
         Left            =   3240
         Top             =   600
      End
...
Private Sub DiaNoche_Timer()
MinutosDiaNoche = MinutosDiaNoche + 1
If MinutosDiaNoche = 60 Then
...
If MinutosTLimpiar = 50 Then
Call SendData(ToAll, 0, 0, "||Se realizará una limpieza del Mundo en 10 minutos. Por favor recojan sus items." & FONTTYPE_VENENO)
End If
If MinutosTLimpiar = 55 Then
Call SendData(ToAll, 0, 0, "||Se realizará una limpieza del Mundo en 5 minutos. Por favor recojan sus items." & FONTTYPE_VENENO)
End If
If MinutosTLimpiar = 59 Then
Call SendData(ToAll, 0, 0, "||Se realizará una limpieza del Mundo en 1 minutos. Por favor recojan sus items." & FONTTYPE_VENENO)
End If
If MinutosTLimpiar = 60 Then
...
For UI = 1 To LastUser
    If UserList(UI).flags.UserLogged And UserList(UI).ConnID <> -1 Then
        ...
        If UserList(UI).flags.Silenciado Then Call TimerSilenc(UI)
