...
For Hechizo = 1 To NumeroHechizos
    ...
    Hechizos(Hechizo).RingNeeded = val(GetVar(DatPath & "Hechizos.dat", "Hechizo" & Hechizo, "RingNeeded"))
...
Public Function EsNiebla()
        If Neblina = False Then
           Neblina = True
         Else
          Neblina = False
        End If
